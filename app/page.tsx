...
// Load client-only auth components with SSR disabled
const AuthNavigation = dynamicImport(
  () => import('@/components/LandingPageAuth').then(mod => ({ default: mod.AuthNavigation })),
  { ssr: false }
)

const AuthHeroCTA = dynamicImport(
  () => import('@/components/LandingPageAuth').then(mod => ({ default: mod.AuthHeroCTA })),
  { ssr: false }
)
